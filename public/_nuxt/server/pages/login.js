...
var VLabel = __webpack_require__(158);
...
var validatable = __webpack_require__(157);
...
var VTextField = __webpack_require__(159);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VInput/index.js + 3 modules
var VInput = __webpack_require__(156);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/login.vue?vue&type=template&id=67157596&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-form',{model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-container',[_c('v-row',[_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.emailRules,"label":"E-mail","required":""},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","md":"4"}},[_c('v-text-field',{attrs:{"rules":_vm.nameRules,"type":"password","label":"Password","required":""},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1)],1),_vm._v(" "),_c('v-btn',{attrs:{"color":"info"},on:{"click":_vm.signInWithEmailAndPassword}},[_vm._v("login")])],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/login.vue?vue&type=template&id=67157596&

// EXTERNAL MODULE: external "js-cookie"
var external_js_cookie_ = __webpack_require__(138);
var external_js_cookie_default = /*#__PURE__*/__webpack_require__.n(external_js_cookie_);

// EXTERNAL MODULE: external "firebase"
var external_firebase_ = __webpack_require__(137);
...
/* harmony default export */ var loginvue_type_script_lang_js_ = ({
  ...
  methods: {
    googleSignIn() {
      this.provider = new external_firebase_default.a.auth.GoogleAuthProvider();
      this.$fireAuth.signInWithPopup(this.provider).then(result => {
        console.log(result); // store the user ore wathever
    ...
    signInWithEmailAndPassword() {
      external_firebase_default.a.auth().signInWithEmailAndPassword(this.email, this.password).then(result => {
        console.log(result); // store the user ore wathever
...
var VForm = __webpack_require__(195);
